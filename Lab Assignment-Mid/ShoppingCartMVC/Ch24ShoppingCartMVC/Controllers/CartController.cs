    ...
    public class CartController : Controller
    {
        ...
        public RedirectToRouteResult List(OrderViewModel order)
        {
            ...
            //Assign the quantity of the selected product to the quantity of the added product
               ...
               // TempData["Total"]= (int)Total + (int)model.AddedProduct.UnitPrice * (int)model.AddedProduct.Quantity;
...
/*        [HttpGet]
        ...
        {
            return View(cart.GetCart.Find(id));
        }*/
 ...
 /*       [HttpPost, ActionName("Delete")]
        ...
        {
            cart.Products.Remove(cart.GetCart.Find(id));
            cart.SaveChanges();
